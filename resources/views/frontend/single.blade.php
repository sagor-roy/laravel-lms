                ...
                <div class="col-md-8">
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="row border-bottom py-2">
                                            ...
                                            <div class="col-md-2">
                                                @if (Auth::check())
                                                @if ($check == true)
                                                <a href="#vimeo{{$class->id}}" uk-toggle>Preview</a>
                                                {{-- <a target="_blank" href="{{route('user.player',[Crypt::encrypt($class->id)])}}" >Preview</a> --}}
                                                <div id="vimeo{{$class->id}}" class="uk-flex-top" uk-modal>
                                                    <div class="uk-modal-dialog uk-width-auto uk-margin-auto-vertical">
                                                        <button class="uk-modal-close-outside" type="button" uk-close></button>
                                                        <iframe src="{{$class->link}}" width="1280" height="720" uk-video uk-responsive></iframe>
                                                    </div>
                                                </div>
                                                @else
                    ...
                    <div class="recent-added mt-5">
                        ...
                        <div class="row py-2">
                            ...
                            <div class="col-5">
                                <a href="{{route('single.course',[$item->id, $item->slug])}}">{{str_title($item->title)}}</a>
                            ...
                            <div class="col-1 text-center">
                                @if (Auth::check())
                                <a title="Wishlist" href="{{route('user.add.wishlist',$item->id)}}"><i class="fa-solid fa-heart fa-2x"></i></a>
                                @else
                    ...
                    <div class="card shadow border-4 border-white">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('user.buy_now')}}" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary w-100 mt-2 btn-lg rounded-0">Buy Now</button>
                            </form>
                            @else
                            <a href="#login" data-bs-toggle="modal" class="btn btn-primary w-100 mt-2 btn-lg rounded-0">Buy Now</a>
                            @endif
                            <div class="mt-4">
                                <p class="m-0">Tags :</p>
                                <div class="d-flex">
