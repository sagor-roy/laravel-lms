    ...
    @foreach ($value->comment as $comment)
        <div class="row my-4">
            <div class="col-md-4 d-flex">
                <img width="40" height="40" src="{{ Avatar::create($comment->user->name)->toBase64() }}"
                    alt="avatar">
                <div class="ms-2">
            ...
            <div class="col-md-8">
                ...
                @auth
                    @if (Auth::user()->role == 'super')
                        <div class="dropdown">
                            <a id="drp{{ $comment->id }}" href="javascript:void(0)" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                Reply
                            </a>

                            <ul class="dropdown-menu p-0 w-100 shadow" aria-labelledby="drp{{ $comment->id }}">
                                <form class="repliesForm">
                                    @csrf
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span><button class="btn bg-white border"><i
                        ...
                        @foreach ($comment->replies as $item)
                            <div class="row pt-2">
                                <div class="col-md-5 d-flex">
                                    <img width="40" height="40" src="{{ Avatar::create('Admin')->toBase64() }}"
                                        alt="avatar">
                                    <div class="ms-2">
