@php
    ...
    $price = 0;
    $values = 0;
    $rating = \App\Models\Comments::where('post_id',$id)->where('price','!=',null)->where('learn','!=',null)->where('value','!=',null)->get();
...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <div class="progress my-2">
            <div class="progress-bar" role="progressbar" style="width: {{round($valuess * 20, 1)}}%;" aria-valuenow="25"
                aria-valuemin="0" aria-valuemax="100">Value-{{round($valuess * 20, 1)}}%</div>
        </div>
    </div>
</div>